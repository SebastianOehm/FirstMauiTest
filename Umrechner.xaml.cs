...
public partial class UmrechnerPage : ContentPage
{
    ...
    { "in", new Unit { Symbol = "\"", Type = UnitType.Length, ToBase = v => v * 0.0254, FromBase = v => v / 0.0254 } },
    { "ft", new Unit { Symbol = "'", Type = UnitType.Length, ToBase = v => v * 0.3048, FromBase = v => v / 0.3048 } },
